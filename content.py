# User-facing strings. Edit here to change wording without touching logic files.
# These are the phrases the LLM is instructed to echo verbatim, plus reusable links.
...
# Reusable links — point to our own frontend.
